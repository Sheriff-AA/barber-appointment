...
from .views import AppointmentPageView, AvailableTimeSlotsView, RequestAppointmentCreateView, UserAppointmentsView, AppointmentsListView, CreateBarberTimeSlotsView, event_list, create_multiple_timeslots
